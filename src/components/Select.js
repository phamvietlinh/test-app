...
import {major_op, unit_op, ques_op} from './question-type-obj';
            ...
            <div className="container">    
                <div className="col-sm-3 col-md-3 col-lg-3">
                    <select name="major" value={this.state.major} className="form-control" onChange={this.handleSelectChange}>
                        <option value="" name="major">Bạn thuộc chuyên môn nào?</option>
                        {this.showOptions()}
                    </select>
                </div>
                ...
                <div className="col-sm-3 col-md-3 col-lg-3">
                    <select name="unit" value={this.state.unit} className="form-control" onChange={this.handleSelectChange}>
                        <option value="" name="unit">Chọn đơn vị bạn đang làm việc</option>
